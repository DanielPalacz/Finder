...
class JobScanner:
    ...
    def _run_www_check_for_the_needed_jobs(
        self, www, job_phrases: list[str], company_data: list[str], lock: multiprocessing.Lock
    ) -> None:
    ...
    def run(self, start_line_number: int = 0) -> None:
        ...
        for company_data in iterate_over_csv_db_file():
            ...
            process = multiprocessing.Process(
                target=self._run_www_check_for_the_needed_jobs, args=(www, JOB_ROLES, company_data, lock)
            )
